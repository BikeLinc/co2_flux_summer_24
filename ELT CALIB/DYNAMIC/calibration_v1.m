...
% Closed Loop Data
cl_files = ["../../DATA/CALIB/07.08.2024/daq_7_8_24.daq", "../../DATA/CALIB/07.08.2024/daq_7_9_24.daq"];
...
% Ambient Data
amb_files = ["../../DATA/CALIB/07.09.2024/24_07_09.daq", "../../DATA/CALIB/07.09.2024/24_07_10.daq"];
...
%% Reference Data
% Closed Loop Data
cl_licor = IMPORTLICORFILE("../../DATA/CALIB/07.08.2024/licor.licor");
cl_licor_idx = cl_licor.T > datetime(cl_times(1)) & cl_licor.T < datetime(cl_times(2));
cl_licor = cl_licor(cl_licor_idx, :);

% Ambient Data
amb_licor = IMPORTLICORFILE("../../DATA/CALIB/07.09.2024/licor_7_10_24.licor");
