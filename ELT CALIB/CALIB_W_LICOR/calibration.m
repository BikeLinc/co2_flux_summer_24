...
exportgraphics(fig_resid, "figs/"+datestr(datetime("today"))+"___resid_just_ambient.png", 'Resolution', '300');
exportgraphics(fig_perf, "figs/"+datestr(datetime("today"))+"___perf_just_ambient.png", 'Resolution', '300');